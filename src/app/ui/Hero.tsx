...
const Hero = () => {
  ...
  return (
    <main className="relative pb-20 md:pb-32 lg:pb-40 overflow-hidden">
      ...
      <div
        className="absolute h-[1722px] left-[50%] top-12 md:top-24 w-[1952.78px] pointer-events-none select-none -z-10 scale-90 transition-opacity duration-500 ease-in delay-500 -translate-x-1/2"
